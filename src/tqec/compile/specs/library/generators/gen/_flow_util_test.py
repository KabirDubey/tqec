...
from . import (Chunk, Flow, PauliString, standard_surface_code_chunk)
...
def test_magic_init_surface_code():
    from midout.circuits.steps._patches import make_xtop_qubit_patch
    p = make_xtop_qubit_patch(distance=3)
    obs = PauliString({0: 'X', 1j: 'X', 2j: 'X'})
